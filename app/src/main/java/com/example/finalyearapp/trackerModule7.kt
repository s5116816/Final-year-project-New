...
class trackerModule7 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tracker_module7)


        //my XML variables from this module's view
        val scrollableList: LinearLayout = findViewById(R.id.trackerList7)
        val deleteTracker = findViewById<Button>(R.id.deleteButton7)
        val circleProgressBar = findViewById<ProgressBar>(R.id.circleProgressBar7)
        val projectTitle = findViewById<TextView>(R.id.projectTitle7)
        val userName = findViewById<TextView>(R.id.userName7)
        ...
        val getJson = arrayPref.getString("taskList7", null)
        ...
        val getUserName = namesPref.getString("userName7", "")
        val getProjectName = namesPref.getString("projectName7", "")
        ...
        deleteTracker.setOnClickListener() {
            ...
            editArray.putString("taskList7", emptyArray)
            editArray.apply()
            ...
            editNames.putString("userName7", "")
            editNames.putString("projectName7", "")
            editNames.apply()
            ...
            unlockTrackerEdit.putBoolean("tracker7", false)
        ...
        fun progressBarUpdate() {
            ...
            val textViewProgressPercentage =
                findViewById<TextView>(R.id.textView_progressPercentage7)
