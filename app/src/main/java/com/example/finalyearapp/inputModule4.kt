...
class inputModule4 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_input_module4)

        //allows textViews to scroll vertically
        val chapterScrollable: TextView = findViewById(R.id.chapterTextView4)
        val artifactScrollable: TextView = findViewById(R.id.artefactTextView4)
    ...
    fun addToChapter(view: View) {
        ...
        val chapterUserInput = findViewById<EditText>(R.id.chapterUserInput4)
        val chapterTextView = findViewById<TextView>(R.id.chapterTextView4)
    ...
    fun addToArtifact(view: View) {
        ...
        val artifactUserInput = findViewById<EditText>(R.id.artifactUserInput4)
        val artifactTextView = findViewById<TextView>(R.id.artefactTextView4)
    ...
    fun saveData(view: View) {
        ...
        if (taskList.size > 25) {
            ...
            val firstName = findViewById<EditText>(R.id.firstName4)
            val projectName = findViewById<EditText>(R.id.projectName4)
            ...
            if (stringName.isEmpty() && stringPName.isEmpty() || stringName.isEmpty() || stringPName.isEmpty()) {
                ...
                namesEdit.putString("userName4", stringName)
                namesEdit.putString("projectName4", stringPName)
                ...
                if (taskList.isEmpty()) {
                    ...
                    jsonEdit.putString("taskList4", json)
                    jsonEdit.apply()
                    ...
                    //storing boolean
                    createTrackerEdit.putBoolean("createTrackerButton4", false)
                    ...
                    unlockTrackerEdit.putBoolean("tracker4", true)
