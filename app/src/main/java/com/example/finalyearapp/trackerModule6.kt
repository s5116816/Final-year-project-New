...
class trackerModule6 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tracker_module6)

        //my XML variables from this module's view
        val scrollableList: LinearLayout = findViewById(R.id.trackerList6)
        val deleteTracker = findViewById<Button>(R.id.deleteButton6)
        val circleProgressBar = findViewById<ProgressBar>(R.id.circleProgressBar6)
        val projectTitle = findViewById<TextView>(R.id.projectTitle6)
        val userName = findViewById<TextView>(R.id.userName6)
        ...
        val getJson = arrayPref.getString("taskList6", null)
        ...
        val getUserName = namesPref.getString("userName6", "")
        val getProjectName = namesPref.getString("projectName6", "")
        ...
        deleteTracker.setOnClickListener() {
            ...
            editArray.putString("taskList6", emptyArray)
            editArray.apply()
            ...
            editNames.putString("userName6", "")
            editNames.putString("projectName6", "")
            editNames.apply()
            ...
            createTrackereEdit.putBoolean("createTrackerButton6", true)
            ...
            unlockTrackerEdit.putBoolean("tracker6", false)
        ...
        fun progressBarUpdate() {
            ...
            val textViewProgressPercentage =
                findViewById<TextView>(R.id.textView_progressPercentage6)
