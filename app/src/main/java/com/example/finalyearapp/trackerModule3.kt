...
class trackerModule3 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tracker_module3)


        //my XML variables from this module's view
        val scrollableList: LinearLayout = findViewById(R.id.trackerList3)
        val deleteTracker = findViewById<Button>(R.id.deleteButton3)
        val circleProgressBar = findViewById<ProgressBar>(R.id.circleProgressBar3)
        val projectTitle = findViewById<TextView>(R.id.projectTitle3)
        val userName = findViewById<TextView>(R.id.userName3)
        ...
        val getJson = arrayPref.getString("taskList3", null)
        ...
        val getUserName = namesPref.getString("userName3", "")
        val getProjectName = namesPref.getString("projectName3", "")
        ...
        deleteTracker.setOnClickListener() {
            ...
            editArray.putString("taskList3", emptyArray)
            editArray.apply()
            ...
            editNames.putString("userName3", "")
            editNames.putString("projectName3", "")
            editNames.apply()
            ...
            createTrackereEdit.putBoolean("createTrackerButton3", true)
            ...
            unlockTrackerEdit.putBoolean("tracker3", false)
        ...
        fun progressBarUpdate() {
            ...
            val textViewProgressPercentage =
                findViewById<TextView>(R.id.textView_progressPercentage3)
