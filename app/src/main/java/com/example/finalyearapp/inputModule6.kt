...
class inputModule6 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_input_module6)

        //allows textViews to scroll vertically
        val chapterScrollable: TextView = findViewById(R.id.chapterTextView6)
        val artifactScrollable: TextView = findViewById(R.id.artefactTextView6)
    ...
    fun addToChapter(view: View) {
        ...
        val chapterUserInput = findViewById<EditText>(R.id.chapterUserInput6)
        val chapterTextView = findViewById<TextView>(R.id.chapterTextView6)
    ...
    fun addToArtifact(view: View) {
        ...
        val artifactUserInput = findViewById<EditText>(R.id.artifactUserInput6)
        val artifactTextView = findViewById<TextView>(R.id.artefactTextView6)
    ...
    fun saveData(view: View) {
        ...
        if (taskList.size > 25) {
            ...
            val firstName = findViewById<EditText>(R.id.firstName6)
            val projectName = findViewById<EditText>(R.id.projectName6)
            ...
            if (stringName.isEmpty() && stringPName.isEmpty() || stringName.isEmpty() || stringPName.isEmpty()) {
                ...
                namesEdit.putString("userName6", stringName)
                namesEdit.putString("projectName6", stringPName)
