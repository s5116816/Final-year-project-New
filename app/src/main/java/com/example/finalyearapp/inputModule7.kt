...
class inputModule7 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_input_module7)

        //allows textViews to scroll vertically
        val chapterScrollable: TextView = findViewById(R.id.chapterTextView7)
        val artifactScrollable: TextView = findViewById(R.id.artefactTextView7)
    ...
    fun addToChapter(view: View) {
        ...
        val chapterUserInput = findViewById<EditText>(R.id.chapterUserInput7)
        val chapterTextView = findViewById<TextView>(R.id.chapterTextView7)
    ...
    fun addToArtifact(view: View) {
        ...
        val artifactUserInput = findViewById<EditText>(R.id.artifactUserInput7)
        val artifactTextView = findViewById<TextView>(R.id.artefactTextView7)
    ...
    fun saveData(view: View) {
        ...
        if (taskList.size > 25) {
            ...
            val firstName = findViewById<EditText>(R.id.firstName7)
            val projectName = findViewById<EditText>(R.id.projectName7)
            ...
            if (stringName.isEmpty() && stringPName.isEmpty() || stringName.isEmpty() || stringPName.isEmpty()) {
                ...
                namesEdit.putString("userName7", stringName)
                namesEdit.putString("projectName7", stringPName)
