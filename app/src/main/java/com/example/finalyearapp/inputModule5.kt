...
class inputModule5 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_input_module5)

        //allows textViews to scroll vertically
        val chapterScrollable: TextView = findViewById(R.id.chapterTextView5)
        val artifactScrollable: TextView = findViewById(R.id.artefactTextView5)
    ...
    fun addToChapter(view: View) {
        ...
        val chapterUserInput = findViewById<EditText>(R.id.chapterUserInput5)
        val chapterTextView = findViewById<TextView>(R.id.chapterTextView5)
    ...
    fun addToArtifact(view: View) {
        ...
        val artifactUserInput = findViewById<EditText>(R.id.artifactUserInput5)
        val artifactTextView = findViewById<TextView>(R.id.artefactTextView5)
    ...
    fun saveData(view: View) {
        ...
        if (taskList.size > 25) {
            ...
            val firstName = findViewById<EditText>(R.id.firstName5)
            val projectName = findViewById<EditText>(R.id.projectName5)
            ...
            if (stringName.isEmpty() && stringPName.isEmpty() || stringName.isEmpty() || stringPName.isEmpty()) {
                ...
                namesEdit.putString("userName5", stringName)
                namesEdit.putString("projectName5", stringPName)
