...
class trackerModule4 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tracker_module4)


        //my XML variables from this module's view
        val scrollableList: LinearLayout = findViewById(R.id.trackerList4)
        val deleteTracker = findViewById<Button>(R.id.deleteButton4)
        val circleProgressBar = findViewById<ProgressBar>(R.id.circleProgressBar4)
        val projectTitle = findViewById<TextView>(R.id.projectTitle4)
        val userName = findViewById<TextView>(R.id.userName4)
        ...
        val getJson = arrayPref.getString("taskList4", null)
        ...
        val getUserName = namesPref.getString("userName4", "")
        val getProjectName = namesPref.getString("projectName4", "")
        ...
        deleteTracker.setOnClickListener() {
            ...
            editArray.putString("taskList4", emptyArray)
            editArray.apply()
            ...
            editNames.putString("userName4", "")
            editNames.putString("projectName4", "")
            editNames.apply()
            ...
            createTrackereEdit.putBoolean("createTrackerButton4", true)
            ...
            unlockTrackerEdit.putBoolean("tracker4", false)
        ...
        fun progressBarUpdate() {
            ...
            val textViewProgressPercentage =
                findViewById<TextView>(R.id.textView_progressPercentage4)
